...
import 'package:shukr/Screens/AdminPages/UserRequestsOrder.dart';
import 'package:shukr/Screens/RateOrder.dart';
import 'package:shukr/items/BottomSheetExample.dart';
            ...
            children: [
              Column(
                  ...
                  children: [
                    ...
                    // ),
                    // SizedBox(height: 1,),
                    new Text(data['user']['mobile']==null?"":data['user']['mobile'],
                      //  data['items_data'][0]['product']['name']==null?"وجبة":data['items_data'][0]['product']['name'],
                      style: TextStyle(
                        fontFamily: "Tajawal",fontWeight: FontWeight.w500,
                        fontSize: 17,
  ...
  Widget partThree(){
    return Row(
      ...
      children: [
        ...
        rate?SizedBox(width: 3,):SizedBox(width: 0,),
        rate? InkWell(
