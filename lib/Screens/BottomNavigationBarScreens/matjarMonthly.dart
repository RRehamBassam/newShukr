...
import 'package:shukr/items/singleOfferGride.dart';
import 'package:shukr/items/singleOrderTajer.dart';
import 'package:shukr/services/helperFunctions.dart';
import 'package:shukr/widget/loading.dart';
import 'dart:convert' as convert;
import '';
class matjerMonthly extends StatefulWidget {
  bool tajerAccount;
  bool Monthly;

  matjerMonthly(this.tajerAccount,this.Monthly);

  @override
  _matjerState createState() => _matjerState(tajerAccount,Monthly);
}

class _matjerState extends State<matjerMonthly> {
  bool tajerAccount;
  bool Monthly;
  bool Admin;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        BoxTop(),
        Admin?Empty? OrdersAdminEmpty():OrdersAdminNotEmpty(true):GridBox(),
      ],
    );
  }
